...
public class MinionBasicControlScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        rbody.MovePosition(rbody.position +  this.transform.forward * inputForward * Time.deltaTime * forwardMaxSpeed + this.transform.right * inputTurn * Time.deltaTime * forwardMaxSpeed);
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        {
            collision.transform.parent.transform.gameObject.SetActive(false);
        }
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        } else if (other.gameObject.name == "HappyCone")
        {
            GameObject child1 = other.transform.parent.transform.GetChild(0).gameObject;
            GameObject child2 = other.transform.parent.transform.GetChild(1).gameObject;
    ...
    {
        if (other.gameObject.name == "AngryCone")
        {
            GameObject child1 = other.transform.parent.transform.GetChild(0).gameObject;
            GameObject child2 = other.transform.parent.transform.GetChild(1).gameObject;
            child1.SetActive(!child1.activeSelf);
